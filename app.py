...
def detail(plant_id):
    ...
    harvest_search = mongo.db.harvests.find({'plant_id': plant_id})
    harvests = []

    for harvest in harvest_search:
...
def edit(plant_id):
    ...
    if request.method == 'POST':
        ...
        changes = { '$set': {'name': name, 'variety': variety, 'photo_url': photo, 'date_planted': date}}
